...
def build_model(BATCH_SIZE, VOCAB_SIZE, EMBED_SIZE, NUM_SAMPLED):
    ...
    with tf.name_scope('data'):
        ...
        negative_samples = (
            tf.placeholder(tf.int32, shape=[NUM_SAMPLED], name='negative_samples'),
    ...
    # Assemble this part of the graph on the CPU.
...
def train(center_node_placeholder, context_node_placeholder, negative_samples_placeholder,
          loss, dataset, optimizer, NUM_EPOCHS, BATCH_SIZE,
          NUM_SAMPLED, care_type, LOG_DIRECTORY, LOG_INTERVAL, MAX_KEEP_MODEL):
    '''
        tensorflow training loop
        epoch start from 1, not 0
    '''
    print('train')
    ...
    with tf.Session() as sess:
        ...
        print('Save final embedding as numpy array')
