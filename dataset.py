...
class Dataset(object):
    ...
    def parse_random_walk_txt(self, random_walk_txt, window_size):
        ...
        word_and_counts = {}
        with open(random_walk_txt, 'r') as f:
            lines = f.readlines()
        for line in lines:
            ...
            for word in sent:
                ...
                if word in word_and_counts:
                    ...
                    word_and_counts[word] = 1
        print('The number of unique words: {}'.format(len(word_and_counts)))
    ...
    def parse_node_type_mapping_txt(self, node_type_mapping_txt, nodeid2index):
        ...
        index2type = {}
        with open(node_type_mapping_txt, 'r') as f:
            for line in f:
        ...
        type2indices = {}
        all_type = set(index2type.values())
        for node_type in all_type:
    ...
    def get_negative_samples(self, pos_index, num_negatives, care_type):
        ...
        if not care_type:
            negative_samples = np.random.choice(len(self.index2nodeid), size=num_negatives)
...
if __name__ == '__main__':
    # test code
    dataset = Dataset(random_walk_txt="./data/douban_shanghai/ueu_RandomWalk.txt",
                      node_type_mapping_txt="./data/douban_shanghai/ueu_nodeTypeMapping.txt", window_size=1)
